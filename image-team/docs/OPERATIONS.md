...
A production-readiness gate now blocks any claim of completeness unless preview/v1/final files actually exist.
...
5. Resolve engine adapter state
6. Check production-readiness gate
7. Wire selected engine for actual generation/editing
8. Save QA + exports
